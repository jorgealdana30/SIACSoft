...
<div class="container" id="wrapper">
    <form role="form" method="post" action="consultarCurso.php" style="width: 24%; background-color: white; position: absolute;top:  12%;left: 5%;">
        <div style="width: 70%" class="input-group">
            <input  placeholder="Ingrese nombre de Asignatura a buscar..." style=" width: 96%;" class="form-control" id="buscar" name="nombre" required type="text">
            <span class="input-group-btn">
    ...
    <div style="position: absolute;top: 20%;left: 5%;width: 85%;word-wrap: break-word;">
        <span style="font-family: 'Source Sans Pro', sans-serif;position: absolute;font-size: 155%;font-weight: bold;word-wrap: break-word;color: white;">Listado de Asignaturas en el sistema.</span>
        <br><br><?php
        if(isset($_POST['nombre'])){
            $_SESSION['SIACSoft']->listarCur($_POST['nombre']);
        }else{
            $_SESSION['SIACSoft']->listarCur('');
        }
        ?>
    </div>
</div>
