...
<form  style="position: absolute; top: 10%; width: 97%" class="form-horizontal" method="post" action="modificarEstudiante.php">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="txtID">ID Estudiante</label>
            <div class="col-md-4">
                <input id="txtID" name="txtID" type="text" placeholder="Indentificación" class="form-control input-md" required>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="submit" id="btnContinuar" name="btnContinuar" class="btn btn-primary" value="Continuar">
            </div>
        </div>
...
<?php
    if (isset($_POST['txtID'])){
        $bool = $_SESSION['SIACSoft']->siEstaEst($_POST['txtID']);
        if ($bool){
            echo "<script type=\"text/javascript\">
                    alert('Estudiante encontrado, proceda a modificarlo');
                </script>";
            header("location: modificarEstudiante2.php");
        }else{
            echo ">
                    alert('Estudiante no encontrado');
                    window.location='modificarmodificarEstudiante.php';
                </script>";
        }
    }
?>
