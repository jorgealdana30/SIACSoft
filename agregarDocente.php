...
<form style="position: absolute; top: 10%; width: 97%" class="form-horizontal" method="post" action="agregarDocente.php">
<fieldset>
...
if (isset($_POST['txtID']) && isset($_POST['txtNombre'])){
    if (isset($_POST['txtApellido']) && isset($_POST['rdioSexo'])){
        if(isset($_POST['txtCursos'])){
            $_SESSION['SIACSoft']->agregarDoc($_POST['txtID'], $_POST['txtNombre'], $_POST['txtApellido'], $_POST['rdioSexo'], $_POST['txtCursos']);
        }
    }
}
?>
