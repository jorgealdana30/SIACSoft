...
<form style="position: absolute; top: 10%; width: 97%" class="form-horizontal" method="post" action="modificarCurso.php">
<fieldset>

<legend>Modificar Curso</legend>

<div class="form-group">
  <label class="col-md-4 control-label" for="txtID">ID Curso</label>  
  <div class="col-md-4">
  <input id="txtID" name="txtID" type="text" placeholder="Código Curso" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="btnContinuar" name="btnContinuar" class="btn btn-primary" onclick="location.href= 'modificarCurso2.php'">Continuar</button>
  </div>
</div>
</fieldset>
</form>
...
if (isset($_POST['txtID'])){
    $bool = $_SESSION['SIACSoft']->siEstaCur($_POST['txtID']);
    if ($bool){
        echo "<script type=\"text/javascript\">
                    alert('Curso encontrado, proceda a modificarlo');
                </script>";
        header("location: modificarCurso2.php");
    }else{
        echo ">
                    alert('Curso no encontrado');
                    window.location='modificarmodificarCurso.php';
                </script>";
    }
}
?>
