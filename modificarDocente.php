...
<form style="position: absolute; top: 10%; width: 97%"  class="form-horizontal" method="post" action="modificarDocente.php">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txtID" name="txtID" type="text" placeholder="Identificación" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="btnContinuar" name="btnContinuar" class="btn btn-primary" onclick="location.href= 'modificarDocente2.php'">Continuar</button>
  </div>
</div>
...
if (isset($_POST['txtID'])){
    $bool = $_SESSION['SIACSoft']->siEstaDoc($_POST['txtID']);
    if ($bool){
        echo "<script type=\"text/javascript\">
                    alert('Docente encontrado, proceda a modificarlo');
                </script>";
        header("location: modificarDocente2.php");
    }else{
        echo ">
                    alert('Docente no encontrado');
                    window.location='modificarmodificarDocente.php';
                </script>";
    }
}
?>
