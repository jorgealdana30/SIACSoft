...
<form style="position: absolute; top: 10%; width: 97%" class="form-horizontal" method="post" action="eliminarEstudiante.php">
<fieldset>

<!-- Form Name -->
<legend>Eliminar Estudiante</legend>
...
if (isset($_POST['txtID'])){
        $_SESSION['SIACSoft']->eliminarEst($_POST['txtID']);
}
?>
</body>
</html>