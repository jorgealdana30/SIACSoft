...
<form style="position: absolute; top: 10%; width: 97%"  class="form-horizontal" method="post" action="modificarEstudiante2.php">
<fieldset>
...
<!-- Text input-->
    <div class="form-group">
        <label class="col-md-4 control-label" for="txtID">ID Estudiante Antiguo</label>
        <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="txtID">ID Estudiante Nueva</label>
  <div class="col-md-4">
 ...
 if (isset($_POST['txtIDV']) && isset($_POST['txtIDN'])){
     if (isset($_POST['txtNombre']) && isset($_POST['txtApellido'])){
         if (isset($_POST['rdioSexo'])){
             $_SESSION['SIACSoft']->modEst($_POST['txtIDV'],$_POST['txtIDN'],$_POST['txtNombre'], $_POST['txtApellido'], $_POST['rdioSexo']);
         }
     }
 }
?>
